...
public final class NasaApi {
    ...
    private <T> T get(final Call<T> call) throws IOException {
        ...
        rateLimit = headers.get("X-RateLimit-Limit") != null ? Integer.parseInt(headers.get("X-RateLimit-Limit")) : -1;
        rateLimitRemaining = headers.get("X-RateLimit-Remaining") != null ? Integer.parseInt(headers.get("X-RateLimit-Remaining")) : -1;
